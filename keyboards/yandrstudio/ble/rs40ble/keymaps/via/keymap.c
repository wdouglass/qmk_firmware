...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		KC_TRNS, KC_TRNS,KC_TRNS,KC_TRNS,UNDERRGB_TOG_K,KC_TRNS,KC_TRNS, KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,
		KC_TRNS, KC_TRNS,KC_TRNS,KC_TRNS,RGB_TOG,RGB_RMOD,RGB_MOD,RGB_VAD,RGB_VAI, KC_UP,         KC_TRNS,
