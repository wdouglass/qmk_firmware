...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	LAYOUT(
        ...
        KC_TAB,  KC_Q,    KC_W,   KC_E,    KC_R,  KC_T,  KC_Y,  KC_U,  KC_I,  KC_O,  KC_P,  KC_LBRC, KC_RBRC, KC_BSPC, KC_BSLS,  KC_PGUP,
        KC_CAPS, KC_A,    KC_S,   KC_D,    KC_F,  KC_G,  KC_H,  KC_J,  KC_K,  KC_L,  KC_SCLN,KC_QUOT,KC_BSLS, KC_ENT,  KC_ENT,   KC_PGDN,
	...
	LAYOUT(
		...
		KC_TRNS, BL_SW_0, BL_SW_1, BL_SW_2, BLE_OFF, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DEL,  KC_TRNS, KC_TRNS,
