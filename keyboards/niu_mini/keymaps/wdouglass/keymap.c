 ...
 */
  [_QWERTY] = LAYOUT_planck_mit(
    ...
    KC_LCTL,KC_LGUI, KC_LALT, MOUSE,  LOWER,       KC_SPC,       RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),
 ...
 */
  [_MOUSE] = LAYOUT_planck_mit(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX,     XXXXXXX,      XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R
    )
